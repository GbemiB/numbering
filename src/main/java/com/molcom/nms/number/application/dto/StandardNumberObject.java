...
@Data
public class StandardNumberObject {
    ...
    private String haveYouReachedAgreement;
    private String haveYouMetFinancialReq;
    private String frequentAssignment;
    private String radioOrCableDeployment;
